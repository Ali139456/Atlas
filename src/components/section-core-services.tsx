...
import { coreServices as defaultCoreServices } from "@/lib/site-content";
import "./section-core-services.css";

type CoreServicesContent = typeof defaultCoreServices;

export function CoreServicesSection({
  content = defaultCoreServices,
}: {
    ...
    <section id="services" className="core-svc relative section-pad overflow-hidden">
      ...
      <div className="site-container relative z-10">
        <div className="core-svc__intro">
          ...
          <p className="core-svc__lead">{content.description}</p>
        </div>
